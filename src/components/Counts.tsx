  ...
  return (
    <div className="bg-[#f8f8f8] text-black">
      <div className="w-[90%] my-0 mx-auto py-[8rem] px-[2rem]">
        <h2 className="text-[2rem] md:text-[2.5rem] lg:text-[3rem] font-semibold uppercase">
          We offer the perfect match of <br />
          properties tailored to your needs
        </h2>
        <p className=" w-[90%] lg:w-1/2 text-[1rem] font-medium text-muted-foreground">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4 my-8 mx-0">
          <h4 className="py-[0.6rem] px-[0.8rem] border-[1px] border-solid border-black font-medium rounded-full flex items-center gap-4 text-sm md:text-[1rem] lg:text-lg">
        ...
        <div className="my-12 mx-0  pt-4">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 pt-6">
            <div>
              <h4 className="text-[4rem] md:text-[5rem] lg:text-8xl">100%</h4>
              <p>Easy & Safe</p>
            </div>
            <div>
              <h4 className="text-[4rem] md:text-[5rem] lg:text-8xl">12K+</h4>
              <p>Property in Sale & Rent</p>
            </div>
            <div>
              <h4 className="text-[4rem] md:text-[5rem] lg:text-8xl">40+</h4>
              <p>Awward Winning</p>
            </div>
          </div>
        </div>
